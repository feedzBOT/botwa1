...
global.prefix = new RegExp('^[' + (opts['prefix'] || '‎AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz/i!#,$%+£¢€¥^°=¶∆×÷π√✓©®:;?&.\\-').replace(/[|\\{}()[\]^$+*?.\-\^]/g, '\\$&') + ']')
...
conn.browserDescription = ['XDX-BOTZ','javascript','whatsapp']
